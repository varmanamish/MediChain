...
class DistributorScanQRPage extends StatefulWidget {
  ...
  @override
  _DistributorScanQRPageState createState() => _DistributorScanQRPageState();
}
...
class _DistributorScanQRPageState extends State<DistributorScanQRPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Scan Batch QR Code'),
    ...
    return const Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(
            'Please wait while we fetch batch details',
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Scan to update transit details and track shipment progress',
              textAlign: TextAlign.center,
              style: TextStyle(
                color: Colors.white.withOpacity(0.9),
                fontSize: 14,
